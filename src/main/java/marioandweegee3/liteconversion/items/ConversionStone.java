...
import marioandweegee3.liteconversion.api.CustomRemainder;
...
public class ConversionStone extends Item implements CustomRemainder {
    ...
    public ActionResult useOnBlock(ItemUsageContext context) {
        ...
        if (hasRecipe(input)) {
            ...
            world.playSound(player, pos.getX(), pos.getY(), pos.getZ(), SoundEvents.ENTITY_EXPERIENCE_ORB_PICKUP,
                    SoundCategory.PLAYERS, 1.0f, 0.2f);
